...
module Make (E : PRE_ORD) = struct
  ...
  (** Exercise: complete the proof of the [sorted_mem] lemma *)

  (*@ lemma sorted_mem: forall x l.
        (forall y. List.mem y l -> E.le x y) /\ sorted_list l <->
        sorted_list (x :: l) *)

  (** Exercise: complete the proof of the [sorted_append] lemma *)
  ...
  (** Exercise: complete the specification of the [merge_aux] function *)
  ...
  (** Exercise: complete the specification of the [merge] function *)
